    ...
    <div>
        ...
        <el-card shadow="hover">
            ...
            <div
                ...
                v-if="siswaStore.list.length > pageSize"
            >
                <el-pagination
                    v-model:current-page="currentPage"
                    v-model:page-size="pageSize"
                    :total="siswaStore.list.length"
                    :page-sizes="[10, 20, 50]"
...
const pagedData = computed(() => {
    ...
    return siswaStore.list.slice(start, start + pageSize.value);
});
