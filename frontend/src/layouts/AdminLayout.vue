      ...
      <el-scrollbar class="sidebar-scroll">
        ...
        >
          ...
          <el-sub-menu index="data-master">
            ...
            <el-menu-item v-if="authStore.isSuperAdmin" index="/tahun-ajaran">
    ...
    <div class="main-container" :class="{ expanded: isCollapsed }">
      ...
      <header class="topbar">
        <div class="topbar-left">
          <el-button @click="isCollapsed = !isCollapsed" text class="toggle-btn">
            <el-icon :size="20"><Fold v-if="!isCollapsed" /><Expand v-else /></el-icon>
          </el-button>
          <el-breadcrumb separator="/">
            <el-breadcrumb-item :to="{ path: '/' }">Home</el-breadcrumb-item>
            <el-breadcrumb-item v-if="pageTitle !== 'Dashboard'">{{ pageTitle }}</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
        <div class="topbar-right">
          ...
          <el-dropdown trigger="click">
            <span class="user-dropdown">
              ...
              <span class="user-name-top">{{ authStore.user?.username }}</span>
...
import {
  Odometer, FolderOpened, School, User, Reading, Calendar,
  Edit, EditPen, DataAnalysis, Trophy, DataBoard, Document,
  UserFilled, Fold, Expand, ArrowDown, SwitchButton,
...
const pageDescriptions: Record<string, string> = {
  Dashboard: 'Selamat datang di panel administrasi Edu-Admin',
